...
@XmlRootElement(name="RequestNoCardReadResult", namespace = "http://web2pay.com/5.0/2009/11/5.1.0/")
...
public class PaymentResult {
    ...
    public String toString() {
        return "RequestNoCardReadResult [txID=" + txID + ", authorisationCode=" + authorisationCode + ", redirectURL="
                + redirectURL + ", authoriseAmount=" + authoriseAmount + ", captureAmount=" + captureAmount
                + ", currency=" + currency + ", merchantRef=" + merchantRef + ", merchantCategory=" + merchantCategory
                + ", returnText=" + returnText + ", txState=" + txState + ", txStateText=" + txStateText
                + ", cvv2ResultCode=" + cvv2ResultCode + ", avsResultCode=" + avsResultCode + ", returnCode="
                + returnCode + ", cardNumberLast4=" + cardNumberLast4 + ", cardType=" + cardType + ", cardTypeName="
                + cardTypeName + ", cardExpiryYYMM=" + cardExpiryYYMM + ", tokenNo=" + tokenNo + ", tokenExpiryYYMM="
                + tokenExpiryYYMM + "]";
    }
