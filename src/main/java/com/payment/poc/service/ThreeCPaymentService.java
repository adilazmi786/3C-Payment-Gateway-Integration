    ...
    public InitialiseResult getIpgSession(String merchantRef, String amount) {
        try {
            ...
            String xml = "<?xml version=\"1.0\" encoding=\"utf-8\"?> <x:Envelope xmlns:x=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:tem=\"http://tempuri.org/\"> <x:Header/> <x:Body> <tem:Initialise> <tem:security_emerchant_id>QikserveTest</tem:security_emerchant_id> <tem:security_validation_code>QikserveTest1</tem:security_validation_code> <tem:trx_merchant_reference>"
                    ...
                    + amount
                    + "</tem:trx_amount_value> <tem:template_id></tem:template_id> <tem:posturl_success>http://localhost:8080/threecpay/success</tem:posturl_success> <tem:posturl_failure>http://localhost:8080/threecpay/failure</tem:posturl_failure> <tem:service_action>InitialiseServiceResponse</tem:service_action> <tem:trx_options>G</tem:trx_options> </tem:Initialise> </x:Body> </x:Envelope>";
    ...
    public String ipageLoad() {
        try {
            ...
            String xml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?> <x:Envelope xmlns:x=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:tem=\"http://tempuri.org/\"> <x:Header /> <x:Body> <tem:Initialise> <tem:security_emerchant_id>QikserveTest</tem:security_emerchant_id> <tem:security_validation_code>QikserveTest1</tem:security_validation_code> <tem:trx_merchant_reference>"
                    ...
                    + "</tem:trx_merchant_reference> <tem:trx_amount_currency_code>GBP</tem:trx_amount_currency_code> <tem:trx_amount_value>"
                    + "1300"
                    + "</tem:trx_amount_value> <tem:template_id /> qikserve.xml <tem:posturl_success>http://localhost:8080/threecpay/success</tem:posturl_success> <tem:posturl_failure>http://localhost:8080/threecpay/failure</tem:posturl_failure> <tem:service_action>InitialiseService</tem:service_action> <tem:trx_options>G</tem:trx_options> <tem:XXX_IPGSESSION_XXX></tem:XXX_IPGSESSION_XXX> </tem:Initialise> </x:Body> </x:Envelope>";
